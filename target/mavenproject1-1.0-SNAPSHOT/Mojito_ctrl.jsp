...
<%
    ...
    if(accion.equals("nuevo")){
        Productos j = new Productos(nombre, tipoUnidad, cantidad, tipoProducto);
...
%>
    <a href="Mojito.jsp"><button type="sumit" class="btn btn-danger" id="btnSummit">Volver a la lista</button></a>
</body>
